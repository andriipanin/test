<?php
/**
 * SEO step 7: Multiple Content boxes with wave + Title
 *
...
<div class="block-seo-step8-section <?php echo $add_waves_check; ?> <?php echo $additional_class; ?>">
    <div class="block-seo-step8-section__container container">
        <?php if ($section_title) : ?>
            <h3 class="block-seo-step8-section__title"><?php echo esc_html($section_title); ?></h3>
        <?php endif; ?>
        <?php if ($content_box_items) : ?>
            <?php foreach ($content_box_items as $content_box) : ?>
                ...
                $cozy_cabin_content_class = !empty($title) ? 'block-seo-step8-section__content' : 'block-seo-step8-section__without_title';
                ?>
